tm.site.sqlite <- function ( SpeciesParams, initial.cohorts, rain, scheduled.fires=NULL, fire.func=function(flam.prop, fire) fire,
        overlap.matrix=0, ov.gen=0, recruitment=TRUE, thinning=NULL, special=NULL, seedling.survival=NULL, session.settings=NULL, database=NULL ) 
{
#tm.site
